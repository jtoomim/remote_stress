...
class BitcoinTestFramework():
    ...
    def _start_logging(self):
        ...
        self.fh = fh = logging.FileHandler(self.options.tmpdir + '/test_framework.log')
        ...
        self.ch = ch = logging.StreamHandler(sys.stdout)
        ...
        if self.options.trace_rpc:
            ...
            self.rpc_handler = logging.StreamHandler(sys.stdout)
            self.rpc_handler.setLevel(logging.DEBUG)
            rpc_logger.addHandler(self.rpc_handler)

    def _stop_logging(self):
        self.log.removeHandler(self.fh)
        self.log.removeHandler(self.ch)
        if self.options.trace_rpc:
            rpc_logger.removeHandler(self.rpc_handler)
